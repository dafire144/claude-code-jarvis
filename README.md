...
- **Minimize to a mini-reactor** — a **–** button collapses the whole panel into a tiny always-on-top **reactor capsule** (live core + session name + status) that tucks into the corner; click it and it **expands back** with a cinematic implosion/bloom morph. One button to declutter, one click to bring it all back.
