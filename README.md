...
- **Minimize to a mini-reactor** — a **–** button collapses the whole panel into a tiny always-on-top **reactor capsule** (live core + session name + status) that tucks into the corner; click it and it **expands back** with a cinematic implosion/bloom morph. And a tiny **floating minimize-all button** lives beside the first capsule of the dock — one click and **every** open panel folds into its capsule, no matter how many sessions are running.
